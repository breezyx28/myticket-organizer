...
const EVENT_FIELD_LABEL_KEYS: Record<string, string> = {
  ...
  ticketSalesStartsAt: 'editor.fields.salesStarts',
  ticketSalesEndsAt: 'editor.fields.salesEnds',
  ticket_sales_starts_at: 'editor.fields.salesStarts',
  ticket_sales_ends_at: 'editor.fields.salesEnds',
  window_start: 'editor.fields.salesStarts',
  window_end: 'editor.fields.salesEnds',
